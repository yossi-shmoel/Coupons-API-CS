...
namespace CouponsApi.Utilities.Auth
{
    public class TokenGenerator
    {
        private static readonly string _key = "Coupons";
        ...
        public static string GenerateToken(string strToEncrypt)
        {
            try
            {
        ...
        public static string UnWrapToken(string strEncrypted)
        {
            try
            {
